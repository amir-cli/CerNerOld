...
serpent = (loadfile "./Home/libs/serpent.lua")()
feedparser = (loadfile "./Home/libs/feedparser.lua")()
json = (loadfile "./Home/libs/JSON.lua")()
mimetype = (loadfile "./Home/libs/mimetype.lua")()
redis = (loadfile "./Home/libs/redis.lua")()
JSON = (loadfile "./Home/libs/dkjson.lua")()
...
local file = io.open("./Home/chat/logs/"..group.."log.txt", "a")
